...
const AddNew = ({ t, show, onHide, onSave, editData, serviceIds, allServiceList }) => {
                            ...
                            return (
                                <FormikForm>
                                    ...
                                    <Form.Group className="mb-3" controlId="vehicleTypeIds">
                                        <Form.Label>{t('vehicleTypes')}</Form.Label>
                                        <Field
                                            isMulti={true}
                                            name="vehicleTypeIds"
                                            component={ReactSelect}
                                    ...
                                    <Form.Group className="mb-3" controlId="isHire">
                                        <Checkbox id="custom-switch" name="isHire" className="" label={values.isHire ? t('Hire Purchase') : t('Not Hire Purchase')} />
