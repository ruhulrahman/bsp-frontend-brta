...
const { t } = useTranslation();
    ...
    const validationSchema = Yup.object().shape({
        ...
        orgIds: Yup.array().required('Minimum one organization is required'),
        ...
        <div>
            <Offcanvas size="sm" show={show} onHide={onHide} placement="end">
                <Offcanvas.Header closeButton>
                    <Offcanvas.Title>{editData ? t('edit') : t('add_new')} {t('vehicleRegistrationMark')}</Offcanvas.Title>
                </Offcanvas.Header>
                <Offcanvas.Body>
                    <Formik
                    ...
                    >
                        {({ values, resetForm, isSubmitting, handleChange, setFieldValue }) => (
                            <FormikForm>
                                ...
                                <Form.Group className="mb-3" controlId="orgIds">
                                    ...
                                    />
                                    <ErrorMessage name="orgIds" component="div" className="text-danger" />
                                </Form.Group>
