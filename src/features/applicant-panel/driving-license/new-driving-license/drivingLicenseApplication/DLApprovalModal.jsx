...
const DLApprovalModal = ({ show = false, onHide = () => {}, onSave = () => {}, editData = null }) => {
                        ...
                        <div className="row px-1 mt-[24px]">
                                ...
                                <div className="card px-[24px] border-none pb-[24px]">
                                    ...
                                    <div className="row">
                                        <div className="col-sm-12">
                                            <MviSubmission editData={editData}></MviSubmission>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-md-6">
                                <div className="card px-[24px] border-none pb-[24px]">
                                    ...
                                    <div className="row">
                                        <div className="col-sm-12">
                                            <DrivingLicenseApprove editData={editData}></DrivingLicenseApprove>
                                        </div>
                                    </div>
                                </div>
                            </div>
