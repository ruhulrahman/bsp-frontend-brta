...
const PaymentForDLSmartCard = ({ t }) => {
    ...
    return (
        <div>
            <div>
                <CardHeader>
                    <CardTitle className='mb-2'>Smart Card Driving License Fees</CardTitle>
                </CardHeader>
                <div>
                    ...
                    <div className='mb-3 card p-[24px] border-none min-h-[300px]'>
                        ...
                        <div className="row mt-[24px] mb-6">
                            ...
                            <button className='btn btn-secondary btn-rounded btn-xs mr-1' onClick={() => navigate(`/applicant-panel/driving-license/new-driving-license/application-for-driving-license`)}>{t('previous')}</button>
...
export default withNamespaces()(PaymentForDLSmartCard)
