...
const DrivingLicenseApplicationPreRequisites = () => {
            ...
            <Row>
                <Col>
                    <Card className="shadow-lg">
                        <Card.Body>
                            <h2 className="text-2xl font-bold text-center mb-2">Prerequisites for Driving License Application</h2>
                            <p className="mb-2 font-[8px]">
                                ...
                                {prerequisites.map((item, index) => (
                                    <li key={index} className="mb-1">
                                        {item.link ? (
                                            item.type === 'file' ? (
                                                <>
                                                    <span className="font-semibold mr-1">{item.text}</span>
                                                    <a href={item.link} download className="text-blue-600 hover:underline">
                                                        Click here
                                                    </a>
                                                </>
                                            ) : (
...
export default (DrivingLicenseApplicationPreRequisites);