                                                ...
                                                <div className="row mb-3">
                                                    ...
                                                    <div className="col-md-12 col-lg-12 col-xl-6">
                                                        <Form.Group className="mb-3" controlId="billOfEntryOfficeCode">
                                                            <Form.Label>{t('billOfEntryOfficeCode')}</Form.Label>
                                                            <Field disabled={isViewable} type="text" name="billOfEntryOfficeCode" className="form-control" placeholder="Enter bill Of Entry Office Code" />
