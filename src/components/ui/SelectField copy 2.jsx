...
export default function SelectField({ options, field, form }) {
  ...
  return (
    <>
      {/* <Field name={name} id={id} component="select">
        {({ field, form, meta }) =>
          // <FormCheck
          //   type="switch"
          //   id={id}
          ...
          //   {...field}
          // />
          <Select options={customOptions} styles={customStyles} {...field} />
      ...
      <Select
        ...
        value={(field.value !== null && field.value !== '') && customOptions ? customOptions.find(option => option.value === field.value) : field.value}
